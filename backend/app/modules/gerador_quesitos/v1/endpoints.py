...
# --- API Endpoint ---
# O endpoint @router.post("/gerar", ...) foi removido.
# A funcionalidade de upload direto de PDF e processamento síncrono neste módulo
# foi descontinuada em favor do fluxo através do serviço transcritor-pdf e
# do endpoint /gerar_com_referencia_documento.
