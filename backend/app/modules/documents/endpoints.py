...
# The endpoint /upload-and-process that previously used PDF_PROCESSOR_SERVICE_URL has been removed.
# The main upload functionality is now handled by POST /upload, which calls
# services.handle_file_upload, which in turn uses the TRANSCRIBER_SERVICE_URL.
